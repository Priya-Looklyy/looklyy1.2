        ...
        {!imageErrors.rightTop && (
          <div className="absolute top-20 right-4 sm:top-24 sm:right-8 md:top-32 md:right-12">
            <Image
              ...
              height={200}
              className="w-auto h-auto max-w-[40vw] sm:max-w-none"
              onError={() => handleImageError('rightTop')}
            />
          </div>
        )}
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full px-4">
            <div className="flex justify-center">
              <Image
                ...
                onError={() => handleImageError('midText')}
              />
            </div>
          </div>
        )}
            ...
            <div className="flex justify-center">
              ...
              >
                <Image
                  ...
                  onError={() => handleImageError('joinCTA')}
                />
              </button>
            </div>
          </div>
        ...
        {!imageErrors.lastPanel && (
          <div className="absolute bottom-0 left-0 right-0 z-10">
            <Image
              ...
              onError={() => handleImageError('lastPanel')}
            />
          </div>
        )}
      </div>

      ...
      <div className="slider-image-container">
        ...
        <div className="slider-overlay">
          <div className="slider-actions">
            ...
            >
              <svg viewBox="0 0 24 24" className="heart-icon" fill={isFavorited(slider.id) ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.5">
            ...
            >
              <svg viewBox="0 0 24 24" className="pin-icon" fill={isPinned(slider.id) ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.5">

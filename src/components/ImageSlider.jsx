          ...
          <div className="slider-actions">
            ...
            >
              <svg viewBox="0 0 24 24" className="heart-icon" fill="currentColor">
                <circle cx="12" cy="12" r="10" className="circle-bg"/>
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" className="heart-shape"/>
              </svg>
            </button>
            <button
            ...
            >
              <svg viewBox="0 0 24 24" className="pin-icon" fill="currentColor">
                <circle cx="12" cy="12" r="10" className="circle-bg"/>
                <path d="M12 2c-3.87 0-7 3.13-7 7 0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" className="pin-shape"/>
              </svg>
            </button>
          </div>
        </div>

...
const ImageSlider = ({ slider, onPinLook, metrics }) => {
        ...
        <div className="bottom-overlay">
          <div className="metrics-container">
            <div className="metric-item">
              ...
              <span className="metric-number">{metrics?.likes || '2.4k'}</span>
            </div>
            <div className="metric-item">
              <svg viewBox="0 0 24 24" className="metric-icon">
                <path d="M5 5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16l-7-3.5L5 21V5z"/>
              </svg>
              <span className="metric-number">{metrics?.saves || '892'}</span>
            </div>
            <div className="metric-item">
              <svg viewBox="0 0 24 24" className="metric-icon">
                <path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
              </svg>
              <span className="metric-number">{metrics?.shopped || '156'}</span>
            </div>
            <div className="metric-item metric-why">

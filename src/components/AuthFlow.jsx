...
const AuthFlow = () => {
  ...
  return (
    ...
    >
      {/* White Transparent Container - 20% width, vertically centered */}
      <div 
        className="w-full"
        style={{
          maxWidth: '20%',
      ...
      >
        {/* Logo and Tagline - Moved Up Slightly */}
        ...
        {/* Instagram Button - Refined with Smaller Icon and Lighter Text */}
          ...
          >
            <div className="flex items-center justify-center gap-2.5">
              {loading && authProvider === 'instagram' ? (
                <>
                  <svg className="animate-spin h-2.5 w-2.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" style={{ color: '#6b7280' }}>
                ...
                <>
                  <svg className="h-2.5 w-2.5" fill="currentColor" viewBox="0 0 24 24" style={{ transition: 'all 0.3s ease', color: '#6b7280' }}>

          ...
          >
            <div className="flex items-center justify-center gap-2.5">
              {loading && authProvider === 'instagram' ? (
                <>
                  <svg className="animate-spin h-2 w-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" style={{ color: '#6b7280' }}>
                ...
                <>
                  <svg className="h-2 w-2" fill="currentColor" viewBox="0 0 24 24" style={{ transition: 'all 0.3s ease', color: '#6b7280' }}>
